...
export default function Signup() {
    ...
    const submit = async () => {
        axios.post('http://localhost:3000/bad-approach-jwt-localstorage/api/signup', {
    ...
    return (
        <div className="w-screen h-screen flex justify-center items-center">
            <div className="rounded-2xl w-120 h-137 border border-neutral-800">
                ...
                <div className="flex flex-col pr-5 pb-5 pl-5">
                    ...
                    <input ref={firstnameRef} type="text" className="p-2 border-neutral-800 rounded-lg border outline-none"></input>
                </div>
                <div className="flex flex-col pr-5 pb-5 pl-5">
                    <p className="font-light text-lg text-white">Lastname</p>
                    <input ref={lastnameRef} type="text" className="p-2 border border-neutral-800 rounded-lg outline-none"></input>
                </div>
                <div className="flex flex-col pr-5 pb-5 pl-5">
                    <p className="font-light text-lg text-white">Email</p>
                    <input ref={emailRef} type="text" placeholder="someone@example.com" className="p-2 border border-neutral-800 rounded-lg outline-none"></input>
                </div>
                <div className="flex flex-col pr-5 pb-5 pl-5">
                    <p className="font-light text-lg text-white">Password</p>
                    <input ref={passwordRef} type="password" className="p-2 border border-neutral-800 rounded-lg outline-none"></input>
                </div>
