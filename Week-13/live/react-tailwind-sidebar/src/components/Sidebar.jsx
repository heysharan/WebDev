import { MenuScale, HomeAlt, Settings, UserCircle, Group, Wallet } from "iconoir-react";
  ...
  if (sidebarOpen) {
    return (
      <div className="w-96 h-screen  bg-white shadow-2xl absolute md:relative">
        <div>
          <div className="flex justify-between mt-5 mr-5 mb-10 ml-5 px-2 py-3 bg-blue-300 rounded-lg">
            <img src="https://webinar.gg/loginLogo.svg" alt="Logo" className="w-40 text-black" />
            <img src={SharanPhoto} alt="SharanPhoto" className='w-10 h-10 rounded-lg'/>
          </div>
